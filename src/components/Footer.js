...
<footer className="bg-blue-300 dark:bg-gray-900">
    <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
      ...
      <div class="sm:flex sm:items-center sm:justify-between">
          ...
          <a href="mailto:rufarochiuta@gmail.com" class="hover:underline">Developed by Rufaro Chiuta</a>.
          </span>
          <div class="flex mt-4 space-x-5 sm:justify-center sm:mt-0">
              ...
              <a href="https://instagram.com/stainmasters_limited?igshid=NGVhN2U2NjQ0Yg==" class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
