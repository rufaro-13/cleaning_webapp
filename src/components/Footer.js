        ...
        <section className='lg:pt-16'>
            ...
            <div className='bg-gray-200'>
                <div className="sm:item-center bg-gray-200 sm:justify-center text-center ">
                    ...
                    <h1 className='sm:tetx-2xl md:text-4xl font-bold text-navcolour'>Why Choose Us</h1>
                </div>
...
<footer className="bg-blue-300 dark:bg-gray-900">
    <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div class="md:flex md:justify-between">
          <div class="mb-6 md:mb-0">
              <Link to="/" class="flex items-center">
                  ...
                  <span class="self-center text-2xl font-semibold whitespace-nowrap text-navcolour dark:text-white">StainMasters</span>
              </Link>
          </div>
          <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              <div>
                  <h2 class="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">Services</h2>
                  <ul class="text-navcolour dark:text-gray-400 font-medium">
                      <li class="mb-1">
                          <Link to="/bathroom_cleaning" class="hover:underline">Bathroom Cleaning</Link>
                      </li>
                      <li class="mb-1">
                      <Link to="/carpet_cleaning" class="hover:underline">Carpet Cleaning</Link>
                      </li>
                      <li class="mb-1">
                      <Link to="/office_cleaning" class="hover:underline">Office Cleaning</Link>
                      </li>
              ...
              <div>
                  ...
                  <ul class="ttext-navcolour mt-11 dark:text-gray-400 font-medium">
                      
                     
                      <li class="mb-1">
                      <Link to="/deep_cleaning" class="hover:underline">Deep Cleaning</Link>
                      </li>
                      
                      <li class="mb-1">
                      <Link to="/event_cleaning" class="hover:underline">After-Event Cleaning</Link>
                      </li>
                      <li >
                      <Link to="/window_cleaning" class="hover:underline">Window Cleaning</Link>
                      </li>
                  </ul>
              </div>
              ...
              <div>
                  ...
                  <ul class="mt-11 text-navcolour dark:text-gray-400 font-medium">
                      
                     
                      <li class="mb-1">
                      <Link to="/kitchen_cleaning" class="hover:underline">Kitchen Cleaning</Link>
                      </li>
                      <li class="mb-1">
                      <Link to="/restaurant_cleaning" class="hover:underline">Restaurant Cleaning</Link>
                      </li>
                      <li>
                      <Link to="/tailored_cleaning" class="hover:underline">Tailored Cleaning</Link>
                      </li>
      ...
      <div class="sm:flex sm:items-center sm:justify-between">
          <span class="text-sm text-navcolour sm:text-center dark:text-gray-400">© 2023 
          <Link to="/" class="hover:underline">StainMastersLtd™</Link>. All Rights Reserved.
          </span>
          <span class="text-sm px-5 text-navcolour sm:text-center dark:text-gray-400"> 
          <a href="mailto:rufarochiuta@gmail.com"target="blank" class="hover:underline">Developed by Rufaro Chiuta</a>.
          </span>
          <div class="flex mt-4 space-x-5 sm:justify-center sm:mt-0">
              <a href="https://www.facebook.com/profile.php?id=61552407106811"target="blank" class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                  <svg class="w-6 h-6" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="blue" viewBox="0 0 8 19">
                        <path fill-rule="evenodd" d="M6.135 3H8V0H6.135a4.147 4.147 0 0 0-4.142 4.142V6H0v3h2v9.938h3V9h2.021l.592-3H5V3.591A.6.6 0 0 1 5.592 3h.543Z" clip-rule="evenodd"/>
                    </svg>
                  <span class="sr-only">Facebook page</span>
              </a>
              <a href="https://api.whatsapp.com/send?phone=447507913398"target="blank" class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                  <svg class="w-6 h-6 bi bi-whatsapp" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="green"  viewBox="0 0 16 16">
              ...
              <a href="https://instagram.com/stainmasters_limited?igshid=NGVhN2U2NjQ0Yg=="target="blank" class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                  <svg class="w-6 h-6 bi bi-instagram" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="red"  viewBox="0 0 16 16">
